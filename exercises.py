chestexercises = [
    ...
    {"name": "Chest Press", "muscle": ["chest", "upper chest", "lower chest"], "equipment": ["machine"], "time": 3, "goal": ["strength", "hypertrophy", "endurance"]},
    {"name": "Crossovers", "muscle": ["chest", "upper chest", "lower chest"], "equipment": ["machine"], "time": 3, "goal": ["hypertrophy", "strength"]},
]

backexercises = [
    {"name": "Pull-ups", "muscle": ["back", "lats", "rhomboids", "traps"], "equipment": ["bodyweight", "machine"], "time": 4, "goal": ["strength", "hypertrophy", "endurance"]},
    {"name": "Chin-ups", "muscle": ["back", "lats", "traps"], "equipment": ["bodyweight", "machine"], "time": 4, "goal": ["strength", "hypertrophy"]},
    {"name": "Rows", "muscle": ["back", "lats", "rhomboids", "traps"], "equipment": ["barbell", "bodyweight", "machine, dumbbell"], "time": 3, "goal": ["strength", "hypertrophy", "endurance"]},
    {"name": "Supermans", "muscle": ["back", "lower bacK", "traps", "rhomboids"], "equipment": ["bodyweight"], "time": 2, "goal": ["strength", "endurance"]},
    ...
    {"name": "Wide Grip Lat Pulldown", "muscle": ["back", "lats"], "equipment": ["machine"], "time": 4, "goal": ["strength", "hypertrophy"]},
    {"name": "T-bar Rows", "muscle": ["back", "lats", "rhomboids", "traps"], "equipment": ["machine"], "time": 4, "goal": ["strength", "hypertrophy"]},
    {"name": "Single Arm Rows", "muscle": ["back", "lats", "rhomboids", "traps"], "equipment": ["dumbbell", "machine"], "time": 4, "goal": ["strength", "hypertrophy"]},
...
shoulderexercises = [
    ...
    {"name": "Reverse Pec Deck Flyes", "muscle": ["shoulders", "delts", "rear delts", "posterior delts"], "equipment": ["machine"], "time": 5, "goal": ["strength", "hypertrophy"]},
]
